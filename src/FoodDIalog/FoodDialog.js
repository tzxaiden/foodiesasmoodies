    ...
    <>
      ...
      <Dialog>
        <DialogBanner img={openFood.img}>
          <DialogBannerName img={openFood.img}>{openFood.name}</DialogBannerName>
        </DialogBanner>
        <Content>
        ...
        <Footer>
          <ConfirmButton disabled={openFood.choices && !choiceRadio.value} onClick={isEditing ? editOrder : addToOrder}>
